...
public class Subscriber extends Entity {
    ...
    private int internetSubscriptions;
    ...
    public Subscriber(long id, String firstName, String lastName, String birthDate,
                      long userId,
                      long accountId) {
        super(id);
        this.firstName = firstName;
    ...
    public int getInternetSubscriptions() {
        return internetSubscriptions;
    }
    
    public void setInternetSubscriptions(int internetSubscriptions) {
