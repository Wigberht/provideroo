...
<mt:admin_layout pageName="new_service"
    ...
    <div class="row">
        <form class="col s8 offset-s2" action="/MainController"
            ...
            <mt:alert_box_error>
                <p>
                    <mt:sdump key="titleError"
                              messageKey="validation.error.tariff_title"/>
                </p>
                <p>
                    <mt:sdump key="descriptionError"
                              messageKey="validation.error.tariff_description"/>
                </p>
                <p>
                    <mt:sdump key="daysError" messageKey="validation.error.days"/>
                </p>
                <p>
                    <mt:sdump key="costError" messageKey="validation.error.cost"/>
                </p>
                <p>
                    <mt:sdump key="currencyError"
                              messageKey="validation.error.currency"/>
                </p>
            </mt:alert_box_error>
